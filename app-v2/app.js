...
const draw =(program, positionBuffer, texcoordBuffer, positionLocation)=> {
  ...
  drawInfos.forEach(function (drawInfo) {
    drawImage(
      ...
      drawInfo.textureInfo.width/2,
      drawInfo.textureInfo.height/2,
      drawInfo.x,
      drawInfo.y,
      program,
      positionBuffer,
...
const drawImage = (tex, texWidth, texHeight, dstX, dstY, program, positionBuffer, texcoordBuffer, positionLocation) => {
  gl.bindTexture(gl.TEXTURE_2D, tex);
